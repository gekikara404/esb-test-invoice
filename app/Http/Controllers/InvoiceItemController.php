...
class InvoiceItemController extends Controller
{
    ...
    public function index(int $invoice_id, Request $request)
    {
        ...
        if ($request->has('key')) {
            ...
            $data = InvoiceItem::where('invoice_id', $invoice_id)->paginate($page);
        }
        $selectColumn = [
            'subject' => 'Name',
        ];
    ...
    public function store(int $invoice_id, Request $request)
    {
        ...
        return redirect()
        ->route('invoices.invoice_items.index', ['invoice' =>$invoice_id])        
    ...
    {
        return view('invoice_items.form', [
    ...
    public function edit(int $invoice_id, $id)
    {
        ...
        $items = Item::all();
        return view('invoice_items.form', compact('invoice', 'data', 'formActionURL', 'label', 'method', 'statusArr','items'));
    }
    ...
    public function update(int $invoice_id, Request $request, $id)
    {
        ...
        $model = InvoiceItem::findOrFail($id);
        $input = $request->all();
